...
{
    char* input_file1;
    input_file1="/Users/yuan/BaiduYun/MyDocument/workspace/MyMatlab/Hybrid_SuperPixel/shirtBoy.jpg";
    /*
    if(argc > 1)
    {
    ...
    */
    ...
    IplImage* img = cvLoadImage("/Users/yuan/inputSuperpixel/BSR/BSDS500/data/images/val/101087.jpg");
    //cv::Mat img = cv::imread("/Users/yuan/inputSuperpixel/shirtBoy.jpg");
    if ((!img))
    {
    ...
    {
        /*
         也就是这里SEEDS算法移动的最小的block就是2*2，然后他有4层，最上面一层就是最后生成的哪个superpixel
         如果生产600pixel
         2*2^3=16,480/16=30,320/16=20,所以最后就是30*20=600个superpixel
        ...
        /*
         200个superpixel的花，就是3*2^3=24,4*2^3=32,也就是20*10这样的安排
         */
    ...
    //正式的superpixel生成函数，上面只是把那些变量给初始化和得到对应的histogram
    seeds.iterate();
    ...
    imageFileName = "./" + imageFileName + "_200fish_labels.png";
